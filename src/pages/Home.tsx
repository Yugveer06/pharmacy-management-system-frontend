...
function Home() {
  ...
  return (
    <div className="min-h-screen w-screen overflow-hidden">
      ...
      {/* About Section */}
      <section id="about" className="z-10 py-16 sm:py-20 bg-gray-100 scroll-mt-24">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-700">
                A comprehensive solution designed to streamline pharmacy operations, ensuring seamless experiences for
                pharmacists, store owners, and customers.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold text-indigo-600 mb-4">Our Mission</h3>
              <p className="text-gray-700">
                To empower pharmacies with modern technology, improve operational efficiency, and deliver excellent
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-700">
                We provide reliable and efficient systems that simplify inventory management and enhance business
                operations.
              </p>
            </div>
          </div>
      ...
      {/* Services Section */}
      <section id="services" className="z-10 py-16 sm:py-20 bg-white scroll-mt-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center text-indigo-600 mb-8 sm:mb-12">
            Our Services
          </h2>
