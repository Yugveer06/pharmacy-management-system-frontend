	...
	return (
		<div className='flex flex-col gap-4 px-2 py-2 sm:flex-row sm:items-center sm:justify-between'>
			<div className='flex items-center gap-2 order-2 whitespace-nowrap text-sm text-muted-foreground sm:order-1'>
				...
				{table.getFilteredSelectedRowModel().rows.length > 0 && (
					<RippleButton
						onClick={deleteFilteredSelectedRows}
						size='sm'
						variant='destructive'
		...
		<Dialog open={isOpen} onOpenChange={onClose}>
			<DialogContent className='sm:max-w-[425px]'>
				<DialogHeader>
					...
					<DialogDescription>
						Enter the details of the new drug below.
					</DialogDescription>
				</DialogHeader>
				<Form {...form}>
					<form
		...
		return (
			<div className='space-y-4'>
				<div className='flex flex-col items-start gap-2'>
					...
					<AddDrugDialog
						isOpen={addDrugDialogOpen}
						onClose={() => setAddDrugDialogOpen(false)}
				...
				<div className='rounded-md border'>
					<PaginationSection
						table={table}
						deleteFilteredSelectedRows={deleteFilteredSelectedRows}
						deleting={deleting}
					/>
