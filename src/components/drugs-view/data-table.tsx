...
const PaginationSection = <TData extends DrugRow>({ table }: { table: TableInstance<TData> }) => {
	return (
...
const DataTable = React.memo(<TData extends DrugRow, TValue>({ columns, data }: DataTableProps<TData, TValue>) => {
