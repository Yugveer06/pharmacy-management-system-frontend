      ...
      <nav className="flex items-center justify-between p-2 pl-4 text-white bg-slate-800  w-[98%] max-w-[1280px] fixed top-2 left-1/2 -translate-x-1/2 rounded-full border-slate-600 shadow-2xl border z-50">
        <div>
          <Link to="/" preventScrollReset={true}>
            ...
            <h1 className="md:hidden hover:tracking-widest transition-[letter-spacing] text-lg font-semibold">PMS</h1>
          </Link>
        </div>
        ...
        <div className="hidden lg:flex gap-8 items-center">
          <Link to="/#home" className={linkStyle} onClick={(e) => handleHashClick(e, "/#home")}>
            Home
          </Link>
          <Link to="/#about" className={linkStyle} onClick={(e) => handleHashClick(e, "/#about")}>
            About
          </Link>
          <Link to="/#services" className={linkStyle} onClick={(e) => handleHashClick(e, "/#services")}>
            Our Services
          </Link>
